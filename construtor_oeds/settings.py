"""
Django settings for construtor_oeds project.
...
env = environ.Env(
    # define tipos e valores padrão (opcional)
    DEBUG=(bool, False)
)
...
WSGI_APPLICATION = 'construtor_oeds.wsgi.application'
    ...
    'default': {
        ...
        'style': {
            'definitions': [
                ...
                {'name': 'url_para_encurtar', 'element': 'span', 'classes': ['url_para_encurtar']},
